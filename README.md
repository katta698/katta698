...
| Focus | Current work |
|:---|:---|
| **Building** | Week 19 - GitOps on EKS: Should You Run Argo CD, or Let AWS? - 52-week AWS Platform Engineering Lab |
...
|:---|:---|:---|
| **AWS Architecture Series** | One enterprise pattern at a time — the decision, the trade-offs, and what it costs when it is made badly. | 56 posts |
| **Azure Architecture Series** | The same treatment on Azure, explained on its own terms rather than as a translation from AWS — written for a reader who may never have opened an AWS console. | 38 posts |
| **GCP Architecture Series** | The same treatment on Google Cloud, written while learning the platform rather than from years of it — which is exactly why every figure is checked against Google's own documentation before it ships. | 37 posts |
...
| **Azure Weekly Lab** | The same on Azure — one capability built and proven to run before it is written about, which is why a lab post goes out when the build works rather than on a fixed day. | 4 of 52 |
| **GCP Weekly Lab** | The same on Google Cloud, on a platform being learned in the open — so the evidence is a screenshot of a control refusing something it is meant to refuse, rather than a claim that it would. | 4 of 52 |
| **AWS Daily Intelligence** | What AWS shipped, and whether it actually changes anything. Every claim cited to official AWS documentation. | 35 posts |
| **AWS Weekly Intelligence** | Everything AWS shipped in one week, ranked, published Saturday once the week is closed. The inventory is built from AWS's own feeds by script, because summarising them by hand missed a third of one week. | 6 posts |
...
- GCP Architecture Series #37 — IAM Conditions: Attribute-Based Access Control — Sep 19, 2026 <a href="https://jayanthkatta.com/blog/gcp-architecture-iam-conditions/"><img src="assets/link-read.svg" height="22" alt="Read post" /></a>
- Azure Architecture Series #38 — App Roles, Scopes and Consent — Sep 19, 2026 <a href="https://jayanthkatta.com/blog/azure-architecture-app-roles-scopes-consent/"><img src="assets/link-read.svg" height="22" alt="Read post" /></a>
