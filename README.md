...
| **GCP Architecture Series** | The same treatment on Google Cloud, written while learning the platform rather than from years of it — which is exactly why every figure is checked against Google's own documentation before it ships. | 44 posts |
...
- Week 6 — I Gave Myself Owner, Then Couldn't Delete My Own Storage Account — Sep 25, 2026 <a href="https://jayanthkatta.com/blog/week-06-deployment-stacks/"><img src="assets/link-read.svg" height="22" alt="Read post" /></a>
<!-- BLOG-POST-LIST:END -->
